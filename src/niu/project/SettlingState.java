package niu.project; /***********************************************************************
 * Module:  niu.myProjects.SettlingState.java
 * Author:  Tom
 * Purpose: Defines the Class niu.myProjects.SettlingState
 ***********************************************************************/
 ...
 *
 */
public class SettlingState implements ProjectState {
    ...
    public void settlement(Project project) {
        // TODO: implement
        System.out.println("项目结算开始...");
        project.setState(project.getInvestorRepaymentState()).settlement();
        System.out.println("项目结算结束...");
    }

    public String toString() {
        return "niu.myProjects.SettlingState";
    }
