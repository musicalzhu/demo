package niu.project; /***********************************************************************
 * Module:  niu.myProjects.DelistingState.java
 * Author:  Tom
 ...
 *
 */
public class DelistingState implements ProjectState {
    ...
    public void settlement(Project project) {
        // TODO: implement
        System.out.println("停牌中，项目部分结算开始...");
        project.setState(project.getInvestorRepaymentState()).settlement();
        System.out.println("停牌中，项目部分结算结束...");
    }

    public String toString() {
        return "niu.myProjects.DelistingState";
    }
